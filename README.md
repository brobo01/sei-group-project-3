...
### Approach
We approached the project very much as it being a team project and that if we worked together then we would be able to create an app with great functionality and impressive user experience and design. From the begining of the project we agreed each team member's focus and general timeline, being that we wanted to get to an MVP stage during day 4 to allow plenty of time for testing, styling and adding seed data.

Every morning we would discuss what we were going to work on, whether anyone had any blockers and wanted to pair code or discuss, how we were doing against the plan and how we were doing for features against the deadline. We would then stay on Zoom all day, taking group breaks throughout the day and working till generally the same time every evening - we very much embraced the 'marathon not sprint' mentality so that no one got 'code blind' and all wrote clean, understandable code. And of course, to have as much fun as possible while doing it!
